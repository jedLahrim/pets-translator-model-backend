...
```
cd existing_repo
git remote add origin https://gitlab.com/boostfily/pets-translator-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/boostfily/pets-translator-backend/-/settings/integrations)
