DOG_LABEL_TYPE = {
    ...
    "the dog is whining for attention, indicating a desire for interaction or play": "seeking for attention",
    ...
    "the dog is barking and whining, showing excitement and a desire for engagement.": "seeking for attention",
    ...
    "the dog is whimpering softly, showing a desire for affection or care.": "seeking for attention",
    ...
    "the dog is whining, indicating a desire for interaction or care.": "seeking for attention",
    "the dog is whining softly, expressing a need for companionship.": "lonely",
    "the puppy is whining cutely, seeking attention and affection from its owner.": "seeking for attention",
    'A soft, plaintive whining sound from a dog, expressing feelings of discomfort or a desire for attention. This sound captures the essence of a dog\'s need for companionship or reassurance.': 'Needy',
    'A high-pitched, heart-wrenching cry from a puppy, conveying innocence and vulnerability. This sound effect is perfect for evoking sympathy and highlighting the emotional needs of young dogs.': 'Vulnerable',
    'A gentle, sorrowful cry from a dog, suggesting a longing for affection and comfort. This sound captures the emotional bond between dogs and their owners, ideal for scenes requiring a heartfelt touch.': 'Longing',
    'A series of whining sounds from a dog, indicating restlessness or a plea for attention. This sound effect effectively portrays a dog\'s emotional state and can be used to enhance narratives involving canine characters.': 'Restless',
